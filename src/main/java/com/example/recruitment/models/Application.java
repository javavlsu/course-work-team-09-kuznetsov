...
public class Application {
    ...
    public String getResult_visirovanya() {
        return this.result_visirovanya;
    }
    ...
    public void setResult_visirovanya(String result_visirovanya) {
        this.result_visirovanya = result_visirovanya;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (this$date_of_completion == null ? other$date_of_completion != null : !this$date_of_completion.equals(other$date_of_completion))
            return false;
        final Object this$result_visirovanya = this.getResult_visirovanya();
        final Object other$result_visirovanya = other.getResult_visirovanya();
        if (this$result_visirovanya == null ? other$result_visirovanya != null : !this$result_visirovanya.equals(other$result_visirovanya))
            return false;
    ...
    public int hashCode() {
        ...
        final Object $result_visirovanya = this.getResult_visirovanya();
        result = result * PRIME + ($result_visirovanya == null ? 43 : $result_visirovanya.hashCode());
    ...
    public String toString() {
        return "Application(id=" + this.getId() + ", title=" + this.getTitle() + ", name_post=" + this.getName_post() + ", number_people=" + this.getNumber_people() + ", requirements=" + this.getRequirements() + ", wage=" + this.getWage() + ", schedule=" + this.getSchedule() + ", date_of_completion=" + this.getDate_of_completion() + ", result_visirovanya=" + this.getResult_visirovanya() + ", user=" + this.getUser() + ")";
    }
}